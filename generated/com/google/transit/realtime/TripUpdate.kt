...
public class TripUpdate(
  ...
  @field:WireField(
    tag = 6,
    adapter = "com.google.transit.realtime.TripUpdate${'$'}TripProperties#ADAPTER",
    schemaIndex = 5,
  )
  @JvmField
  ...
  public class StopTimeUpdate(
    ...
    @field:WireField(
      tag = 5,
      adapter =
          "com.google.transit.realtime.TripUpdate${'$'}StopTimeUpdate${'$'}ScheduleRelationship#ADAPTER",
      schemaIndex = 5,
    )
    @JvmField
    ...
    @field:WireField(
      tag = 6,
      adapter =
          "com.google.transit.realtime.TripUpdate${'$'}StopTimeUpdate${'$'}StopTimeProperties#ADAPTER",
      schemaIndex = 6,
    )
    @JvmField
