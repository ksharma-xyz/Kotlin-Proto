...
public class TripModifications(
  ...
  @field:WireField(
    tag = 1,
    adapter = "com.google.transit.realtime.TripModifications${'$'}SelectedTrips#ADAPTER",
  ...
  @field:WireField(
    tag = 4,
    adapter = "com.google.transit.realtime.TripModifications${'$'}Modification#ADAPTER",
    label = WireField.Label.REPEATED,
    schemaIndex = 3,
  )
  @JvmField
  ...
  public class Modification(
    ...
    @field:WireField(
      tag = 1,
      adapter = "com.google.transit.realtime.StopSelector#ADAPTER",
      schemaIndex = 0,
    )
    @JvmField
    ...
    @field:WireField(
      tag = 4,
      adapter = "com.google.transit.realtime.ReplacementStop#ADAPTER",
      label = WireField.Label.REPEATED,
      schemaIndex = 3,
    )
    @JvmField
