...
// Source: xyz.ksharma.transport.VehiclePosition in xyz/ksharma/transport/gtfs_realtime.proto
...
public class VehiclePosition(
  ...
  @field:WireField(
    tag = 2,
    adapter = "xyz.ksharma.transport.Position#ADAPTER",
    schemaIndex = 2,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 4,
    adapter = "xyz.ksharma.transport.VehiclePosition${'$'}VehicleStopStatus#ADAPTER",
    schemaIndex = 5,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 6,
    adapter = "xyz.ksharma.transport.VehiclePosition${'$'}CongestionLevel#ADAPTER",
    schemaIndex = 7,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 11,
    adapter = "xyz.ksharma.transport.VehiclePosition${'$'}CarriageDetails#ADAPTER",
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VehiclePosition> = object : ProtoAdapter<VehiclePosition>(
      ...
      "type.googleapis.com/xyz.ksharma.transport.VehiclePosition", 
      PROTO_2, 
      null, 
  ...
  public class CarriageDetails(
    ...
    public companion object {
      ...
      public val ADAPTER: ProtoAdapter<CarriageDetails> = object : ProtoAdapter<CarriageDetails>(
        ...
        "type.googleapis.com/xyz.ksharma.transport.VehiclePosition.CarriageDetails", 
        PROTO_2, 
        null, 
        "xyz/ksharma/transport/gtfs_realtime.proto"
      ) {
