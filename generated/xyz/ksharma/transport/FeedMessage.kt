...
// Source: xyz.ksharma.transport.FeedMessage in xyz/ksharma/transport/gtfs_realtime.proto
...
public class FeedMessage(
  ...
  @field:WireField(
    tag = 1,
    adapter = "xyz.ksharma.transport.FeedHeader#ADAPTER",
  ...
  @field:WireField(
    tag = 2,
    adapter = "xyz.ksharma.transport.FeedEntity#ADAPTER",
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<FeedMessage> = object : ProtoAdapter<FeedMessage>(
      ...
      FeedMessage::class, 
      "type.googleapis.com/xyz.ksharma.transport.FeedMessage", 
      PROTO_2, 
      null, 
