...
// Source: xyz.ksharma.transport.Alert in xyz/ksharma/transport/gtfs_realtime.proto
...
public class Alert(
  ...
  @field:WireField(
    tag = 6,
    adapter = "xyz.ksharma.transport.Alert${'$'}Cause#ADAPTER",
    schemaIndex = 2,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 7,
    adapter = "xyz.ksharma.transport.Alert${'$'}Effect#ADAPTER",
    schemaIndex = 3,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 8,
    adapter = "xyz.ksharma.transport.TranslatedString#ADAPTER",
    schemaIndex = 4,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 14,
    adapter = "xyz.ksharma.transport.Alert${'$'}SeverityLevel#ADAPTER",
    schemaIndex = 9,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 15,
    adapter = "xyz.ksharma.transport.TranslatedImage#ADAPTER",
    schemaIndex = 10,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 1,
    adapter = "xyz.ksharma.transport.TimeRange#ADAPTER",
  ...
  @field:WireField(
    tag = 5,
    adapter = "xyz.ksharma.transport.EntitySelector#ADAPTER",
    label = WireField.Label.REPEATED,
    schemaIndex = 1,
  )
  @JvmField
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<Alert> = object : ProtoAdapter<Alert>(
      ...
      Alert::class, 
      "type.googleapis.com/xyz.ksharma.transport.Alert", 
      PROTO_2, 
      null, 
