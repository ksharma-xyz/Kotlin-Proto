...
// Source: xyz.ksharma.transport.FeedHeader in xyz/ksharma/transport/gtfs_realtime.proto
...
public class FeedHeader(
  ...
  @field:WireField(
    tag = 2,
    adapter = "xyz.ksharma.transport.FeedHeader${'$'}Incrementality#ADAPTER",
    schemaIndex = 1,
  )
  @JvmField
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<FeedHeader> = object : ProtoAdapter<FeedHeader>(
      ...
      FeedHeader::class, 
      "type.googleapis.com/xyz.ksharma.transport.FeedHeader", 
      PROTO_2, 
      null, 
