...
// Source: protos.Pokemon in xyz/ksharma/pokemon/pokemon.proto
@file:Suppress("DEPRECATION")

package xyz.ksharma.pokemon.protos
...
public class Pokemon(
...
) : Message<Pokemon, Pokemon.Builder>(ADAPTER, unknownFields) {
  @field:WireField(
    tag = 3,
    adapter = "xyz.ksharma.pokemon.protos.Pokemon${'$'}Type#ADAPTER",
  ...
  override fun toString(): String {
    ...
    result += """maxHp=$maxHp"""
    return result.joinToString(prefix = "Pokemon{", separator = ", ", postfix = "}")
  }
  ...
  ): Pokemon = Pokemon(name, pokedex_number, type, maxHp, unknownFields)

  public class Builder : Message.Builder<Pokemon, Builder>() {
    @JvmField
    ...
    override fun build(): Pokemon = Pokemon(
      name = name,
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<Pokemon> = object : ProtoAdapter<Pokemon>(
      FieldEncoding.LENGTH_DELIMITED, 
      Pokemon::class, 
      "type.googleapis.com/protos.Pokemon", 
      PROTO_3, 
      null, 
      "xyz/ksharma/pokemon/pokemon.proto"
    ) {
      override fun encodedSize(`value`: Pokemon): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: Pokemon) {
        if (value.name != "") {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: Pokemon) {
        writer.writeBytes(value.unknownFields)
        if (value.maxHp != 0) {
          ProtoAdapter.INT32.encodeWithTag(writer, 4, value.maxHp)
        }
      ...
      override fun decode(reader: ProtoReader): Pokemon {
        var name: String = ""
      ...
      override fun redact(`value`: Pokemon): Pokemon = value.copy(
    ...
    @JvmSynthetic
    public inline fun build(body: Builder.() -> Unit): Pokemon = Builder().apply(body).build()
  }
