...
public class FeedEntity(
  ...
  @field:WireField(
    tag = 3,
    adapter = "xyz.ksharma.transit.realtime.TripUpdate#ADAPTER",
    schemaIndex = 2,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 4,
    adapter = "xyz.ksharma.transit.realtime.VehiclePosition#ADAPTER",
    schemaIndex = 3,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 5,
    adapter = "xyz.ksharma.transit.realtime.Alert#ADAPTER",
    schemaIndex = 4,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 6,
    adapter = "xyz.ksharma.transit.realtime.Shape#ADAPTER",
    schemaIndex = 5,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 7,
    adapter = "xyz.ksharma.transit.realtime.Stop#ADAPTER",
    schemaIndex = 6,
  )
  @JvmField
  ...
  @field:WireField(
    tag = 8,
    adapter = "xyz.ksharma.transit.realtime.TripModifications#ADAPTER",
    schemaIndex = 7,
  )
  @JvmField
